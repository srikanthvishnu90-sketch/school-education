 ...
 * not a disabled composer dressed up to look interactive. The plumb-line motif
 * that names the promise (settle to what's actually true) sits above, as the
 * hero's focal mark. The button carries the selected role into the sign-in
 * flow, so the toggle decides which door opens.
 */
