...
export default async function LessonsPage(): Promise<ReactElement> {
  ...
  return (
    ...
    >
      {/* Faint graph-paper ground — the notebook signature behind the dashboard. */}
      <div className="graph-paper">
        <div className="flex items-baseline justify-between">
          <div className="flex items-center gap-2.5">
            <PlumbLine height={30} className="text-ink-black" />
            <h1 className="font-voice text-2xl font-semibold tracking-tight text-ink-black">
              Home
            </h1>
          </div>
